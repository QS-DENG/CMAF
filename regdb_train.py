    ...
    for batch_idx, (input1, input2, label1, label2) in enumerate(trainloader):
        ...
        if batch_idx % 50 == 0:
            print('Epoch: [{}][{}/{}] '
                ...
                train_loss=train_loss, id_loss=id_loss, tri_loss=tri_loss, dcl_loss=dcl_loss, cpm_loss=cpm_loss,
                ort_loss=ort_loss))
...
for epoch in range(start_epoch, 151 - start_epoch):
    ...
    if epoch > 0 and epoch % 1 == 0:
        ...
        tp_mINP = best_mINP
        if mINP7 > best_mINP and cmc7[0] <= tp_acc:  # not the real best for sysu-mm01
            best_mINP = mINP7
            best_epoch = epoch
            state = {
                'net': net.state_dict(),
        ...
        tp_amp = best_amp
        if mAP7 > best_amp and cmc7[0] <= tp_acc and mINP7 <= tp_mINP:  # not the real best for sysu-mm01
            best_amp = mAP7
            best_epoch = epoch
            state = {
                'net': net.state_dict(),
